  ...
  return (
    <section className='Sobre' id='Sobre'>
        ...
        <div className='container'>
            <h2>Conheça um pouco mais da história da S4 e nossa visão</h2>
            <p>A <strong>S4 Cursos e Treinamentos</strong> através do seu idealizador, iniciou suas atividades no ano de 1998 no município de Paranaguá - PR, com o objetivo inicial de difundir à comunidade, através de palestras e trabalhos voluntários, o padrão de atendimento inicial à vítimas da “Doença” Trauma.</p>
